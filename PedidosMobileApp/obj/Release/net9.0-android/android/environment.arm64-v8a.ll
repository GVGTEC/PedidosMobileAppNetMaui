...
@application_config = dso_local local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 u0x020002bb, ; uint32_t android_runtime_jnienv_class_token
	i32 u0x06001a89, ; uint32_t jnienv_initialize_method_token
	i32 u0x06001a88, ; uint32_t jnienv_registerjninatives_method_token
...
@aot_dso_cache = dso_local local_unnamed_addr global [819 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.55_name, ; name: libaot-Microsoft.Win32.Primitives.dll.so
		ptr null; void* handle
	}, ; 63
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.22_name, ; name: libaot-Microsoft.Win32.SystemEvents.dll.so
		ptr null; void* handle
	}, ; 73
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.23_name, ; name: libaot-System.Drawing.Common.dll.so
		ptr null; void* handle
	}, ; 75
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 u0x2b9fba461f1af6ba, ; from name: aot-PedidosMobileApp.so
		i64 u0xd49bd5f6c19e2a25, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-PedidosMobileApp.dll.so
		ptr null; void* handle
	}, ; 140
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 u0x3e09f7b0dfdcead1, ; from name: libaot-PedidosMobileApp.so
		i64 u0xd49bd5f6c19e2a25, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-PedidosMobileApp.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x4dee20a72eed5881, ; from name: PedidosMobileApp
		i64 u0xd49bd5f6c19e2a25, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-PedidosMobileApp.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x5e695f5c58aefcd7, ; from name: aot-PedidosMobileApp.dll.so
		i64 u0xd49bd5f6c19e2a25, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-PedidosMobileApp.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x71de369a89441cda, ; from name: PedidosMobileApp.dll.so
		i64 u0xd49bd5f6c19e2a25, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-PedidosMobileApp.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x82a8fa0d680e51e4, ; from name: aot-PedidosMobileApp
		i64 u0xd49bd5f6c19e2a25, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-PedidosMobileApp.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x96202208c58a054a, ; from name: libaot-PedidosMobileApp
		i64 u0xd49bd5f6c19e2a25, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-PedidosMobileApp.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x9cead59fe11567ad, ; from name: PedidosMobileApp.so
		i64 u0xd49bd5f6c19e2a25, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-PedidosMobileApp.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xd49bd5f6c19e2a25, ; from name: libaot-PedidosMobileApp.dll.so
		i64 u0xd49bd5f6c19e2a25, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-PedidosMobileApp.dll.so
		ptr null; void* handle
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [28 x i8] c"net.gvgtec.pedidosmobileapp\00", align 1
...
@.DSOCacheEntry.8_name = private unnamed_addr constant [31 x i8] c"libaot-PedidosMobileApp.dll.so\00", align 1
...
@.DSOCacheEntry.22_name = private unnamed_addr constant [43 x i8] c"libaot-Microsoft.Win32.SystemEvents.dll.so\00", align 1
@.DSOCacheEntry.23_name = private unnamed_addr constant [36 x i8] c"libaot-System.Drawing.Common.dll.so\00", align 1
...
@.DSOCacheEntry.55_name = private unnamed_addr constant [41 x i8] c"libaot-Microsoft.Win32.Primitives.dll.so\00", align 1
